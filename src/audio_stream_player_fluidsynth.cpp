...
void AudioStreamPlaybackFluidSynth::_seek(double p_time) {
    if (p_time < 0) {
        p_time = 0;
    }
...
int AudioStreamPlaybackFluidSynth::_mix(AudioFrame *p_buffer, double p_rate, int p_frames) {
...
int AudioStreamPlaybackFluidSynth::_get_loop_count() const {
    return 10;
}
...
float AudioStreamPlaybackFluidSynth::_get_length() const {
    return 0.0;
}
