...
int AudioStreamPlaybackMyTone::_mix(AudioFrame *p_buffer, float p_rate,
                                    int p_frames) {
...
int AudioStreamPlaybackMyTone::_get_loop_count() const { return 10; }
double AudioStreamPlaybackMyTone::_get_playback_position() const {
    return mixed;
}
float AudioStreamPlaybackMyTone::_get_length() const { return 0.0; }
bool AudioStreamPlaybackMyTone::_is_playing() const { return active; }
